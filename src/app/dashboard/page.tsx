          ...
          <div className="space-y-3">
            {alerts
              ...
              .map((alert, i) => (
                <div
                  key={i}
                  className={`rounded-lg p-3 text-xs ${alert.type === "missed"
          ...
          {recentJobs.map((job) => (
            <div key={job.name}>
              ...
              <div className="h-2 rounded-full bg-gray-100">
                <div
                  className={`h-2 rounded-full transition-all ${job.pct >= 85 ? "bg-red-400" : job.pct >= 75 ? "bg-amber-400" : "bg-green-400"
                    }`}
                  style={{ width: `${job.pct}%` }}
                />
              </div>
